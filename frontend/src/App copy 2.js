...
import './assets/styles/components/Auth/LoginPage';
...
function App() {
  ...
  return (
    <Router>
      {/* ... AuthProvider if you have one ... */}
      <div className="app-container">
        {/* The Navbar component must be a direct child of .app-container */}
        <Navbar onLogout={handleLogout} toggleSidebar={toggleSidebar} />
  
        {/* This new wrapper holds the sidebar and main content */}
        {/* This div needs to be conditionally rendered only when logged in, or always present with login page outside */}
        {!isLoggedIn ? (
            <LoginPage onLogin={handleLogin} />
        ) : (
            <div className="dashboard-layout-wrapper"> {/* <<< ADD THIS WRAPPER */}
